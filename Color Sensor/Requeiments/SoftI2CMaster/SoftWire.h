...
#ifdef USE_DEFAULT_I2C_PINS  
    // pino A4 e A5 do arduino
    #define SDA_PORT PORTC
    #define SDA_PIN 4 // = Pin 6
    #define SCL_PORT PORTC
    #define SCL_PIN 5 // = Pin 7    
  #else
    // pino 6 e 7 do arduino
    #define SDA_PORT PORTD
    #define SDA_PIN 6 // = Pin 6
    #define SCL_PORT PORTD
    #define SCL_PIN 7 // = Pin 7    
  #endif
#endif
...
// #define SCL_PIN 5 // = Pin 7
#define SDA_PORT PORTD
#define SDA_PIN  2// = Pin 19
#define SCL_PORT PORTD
#define SCL_PIN 3 // = Pin 18  
#endif
